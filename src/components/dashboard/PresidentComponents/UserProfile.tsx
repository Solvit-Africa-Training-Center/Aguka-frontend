...
const UserProfile: React.FC = () => {
  ...
  // Initialize state once when userData is available
  useEffect(() => {
    if (userData) {
  ...
  return (
    <div className="min-h-screen bg-[#00353B] flex flex-col items-center justify-start p-6 space-y-6">
      ...
      <div className="bg-[#00353B] text-white rounded-xl w-full max-w-md p-6 flex flex-col space-y-4">
        {/* Phone */}
        <div className="flex items-center justify-between border border-yellow-500 rounded px-3 py-2">
          <input
            type="text"
            value={phoneNumber}
        ...
        {/* Join Date */}
        <div className="px-3 py-2 border border-yellow-500 rounded text-white">
        ...
        <div className="flex flex-col space-y-2 border border-yellow-500 rounded px-3 py-2">
          ...
          {editingPassword ? (
            <input
              ...
              className="bg-transparent border border-yellow-500 rounded px-2 py-1 text-white focus:outline-none"
            />
          ) : (
      ...
      <div className="flex space-x-4 w-full max-w-md justify-end">
        <button className="flex-1 bg-gray-200 text-black rounded-lg py-2 hover:bg-gray-300">
          ← Back
        </button>
        <button
          onClick={handleSave}
