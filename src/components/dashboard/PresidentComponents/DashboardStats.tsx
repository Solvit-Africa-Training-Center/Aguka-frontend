...
const DashboardStats: React.FC = () => {
  ...
  const pendingRequestsCount = useMemo(() => {
    ...
    const pendingGroupLoans = pendingLoans.filter((loan) =>
      users.some((u) => u.id === loan.userId)
    );
    ...
    <div className="w-full font-poppins pt-6 px-4 md:px-0">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatsCard
          ...
          value={
            loadingContributions
              ? "..."
              : `Frw ${totalSavings.toLocaleString()}`
          }
          icon={DollarSign}
        />
        <StatsCard
          ...
          value={
            loadingApprovedLoans
              ? "..."
              : `Frw ${totalLoanDisbursed.toLocaleString()}`
          }
          icon={ArrowUpCircle}
        />
        {/* <StatsCard
        ...
        <StatsCard
          ...
          value={
            loadingUsers || loadingPendingLoans
              ? "..."
