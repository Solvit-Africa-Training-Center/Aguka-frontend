...
export default function MembersPage() {
  ...
  (user.phoneNumber?.toString().includes(search) ?? false) ||
  (user.id?.toString().includes(search) ?? false);
...
const exportMembers = () => {
  ...
  return (
    <div className="p-15 bg-[#003B42] min-h-screen text-white font-poppins">
      ...
      <div className="overflow-auto max-h-[600px] rounded-lg shadow-md">
        <table className="w-full text-left border-collapse">
          <thead className="text-[#FFFFFF] text-xl font-bold sticky top-0 ">
            <tr>
                ...
                <td className="p-3">
                  <span
                    className={`px-2 py-1 rounded-lg text-sm ${
                      user.isApproved
                        ? "bg-[#C5E2C6] text-[#3C9040]"
                        : "bg-[#CE3330] text-[#000000]"
                    }`}>
                    {user.isApproved ? "Active" : "Inactive"}
                  </span>
                </td>
                <td className="p-3">
                  <span className="bg-[#C3C3C3] text-[#000000] px-2 py-1 rounded-lg text-sm">
                    {user.role}
                  </span>
                </td>
...
<div className="mt-6 flex justify-center">
  <button
    ...
    className="text-white font-semibold px-6 py-3 rounded-lg flex items-center gap-2 bg-[#003B42] hover:bg-[#004d52] transition"
  >
    <Download size={25} className="text-[#E09721]" />
    <span className="text-xl">Export Members</span>
  </button>
</div>
