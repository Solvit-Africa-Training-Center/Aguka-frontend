...
export default function MembersList() {
  ...
  const activeCount = filteredUsers.filter((u) => u.isApproved).length;
  const InactiveCount = filteredUsers.filter((u) => !u.isApproved).length;
    ...
    <div className="p-15 bg-[#002D2D] min-h-screen text-white pt-60 font-poppins">
      <div className="flex gap-6 mb-6 justify-between">
        <div className="border border-secondary-400 w-100 h-50 text-center text-2xl font-bold pt-4 space-y-13 rounded-2xl">
          <h2>Total Members</h2>
          <span className="text-4xl">{TotalMembers}</span>
        </div>
        <div className="border border-secondary-400 w-100 h-50 text-center text-2xl font-bold pt-4 space-y-13 rounded-2xl">
          <h2>Active Members</h2>
          <span className="text-4xl">{activeCount}</span>
        </div>
        <div className="border border-secondary-400 w-100 h-50 text-center text-2xl font-bold pt-4 space-y-13 rounded-2xl">
          <h2>Inactive Members</h2>
          <span className="text-4xl">{InactiveCount}</span>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-4 mb-6 ">
        <div className="relative flex items-center">
          ...
          <input
            ...
            className="pl-10 pr-4 py-4 w-200 rounded-lg bg-transparent border border-gray-400 text-white placeholder-gray-400 focus:outline-none"
          />
        </div>
