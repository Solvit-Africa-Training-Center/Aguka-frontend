...
const AgukaJourney = () => {
  return (
    <div className="w-full p-10 bg-[#003B42CC] place-items-center  text-white font-poppins">
      <div className="p-10 border-0 rounded-2xl bg-[#456E73] w-200 h-80 space-y-8 text-left">
        ...
        <div className="flex gap-8  ml-40   ">
          <button className="p-4 flex gap-2 bg-[#003B42] w-50 h-16 capitalize rounded-md items-center ">
