...
const KeyMetrics: React.FC = () => {
  return (
    <div className="w-full bg-[rgba(0,59,66,1)] text-white pt-[79px] pb-[79px] pr-[110px] pl-[110px] font-poppins ">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3   space-y-15 text-2xl capitalize text-center w-full ">
        <div className="bg-[#307780] rounded-md w-[450px] h-[365px] place-items-center pt-20">
          <Users className="size-10 mb-10 text-secondary-300" />
        ...
        <div className="bg-[#307780]  rounded-md w-[450px] h-[365px] place-items-center pt-20 ">
          <DollarSign className="size-10 mb-10 text-secondary-300" />
