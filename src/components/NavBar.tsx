    ...
    <div>
      <div className="w-full text-white text-xl bg-[#003B42] flex justify-between items-center border-b border-primary-200 fixed font-poppins px-6 lg:px-[114px] py-3 z-20">
        <div className="flex justify-between items-center w-full">
          {/* Logo */}
          <div className="w-[50px] sm:w-[60px] md:w-[80px] lg:w-[90px]">
            <img
              src={logo}
              alt="aguka logo"
      ...
      {isOpen && (
        <div className="lg:hidden fixed top-[70px] left-0 w-full bg-[#003B42] text-white z-20  p-6 space-y-6 space-x-8 font-bold">
          ...
          <div className="space-y-4 pt-4 pr-10">
            <button
              onClick={handleLogin}
