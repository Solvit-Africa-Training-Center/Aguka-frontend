...
const NavBar: React.FC = () => {
  ...
  return (
    <div>
      {/* Top Bar */}
      <div className="w-full font-poppins text-white text-xl bg-[#003B42] flex justify-between items-center border-b border-primary-200 fixed font-poppins px-6 lg:px-[114px] py-3 z-20">
        {/* Logo */}
