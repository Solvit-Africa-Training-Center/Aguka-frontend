    ...
    <div className="w-full  font-poppins bg-[#003B42] text-white">
      ...
      <div className="text-center  capitalize p-20 ">
        ...
        <div className="w-full h-[388px]">
          <div className="grid grid-cols-2 gap-10 pt-10 ">
            <div className="w-[646px] h-[388px] grid justify-between  text-left">
              <IoCard className="size-15 text-secondary-300" />
              <h1 className="text-[#F4F4F4] text-[48px] font-bold">
                secure contribution
              </h1>
              <span className="text-[#F4F4F4] text-[32px] font-poppins">
            ...
            <div className="w-[646px] h-[388px] grid justify-between  text-left">
              <div className="flex gap-2">
                <SlChart className="size-15 text-secondary-300" />
              </div>
        ...
        <div className="">
          <h1 className="text-[96px]">why choose Aguka Services</h1>
          <img
            src="image/a37628210e9032f7556be6b22e02808bb3992ac1.jpg"
            alt="why choose aguka"
            className="w-[1592px] h-[972px] mt-4 ml-[68px] rounded-[30px]"
          />
          ...
          <div className="space-y-15 m-15">
            ...
            <div className="flex gap-10 place-content-center text-3xl font-bold font-poppins ">
              <button className="bg-[#F9A825] text-black p-4 rounded-2xl ">
                Create your circle
              </button>
              <button className="bg-[#82807D] text-white p-4 rounded-2xl ">
                Join a group
              </button>
            </div>
