  ...
  return (
    <div className="min-h-screen bg-[var(--color-primary-300)]  grid items-start py-20 ">
      <div>
          ...
          <div className="space-y-8">
            {faqs.map((faq, idx) => (
              <div key={idx} className="pb-4">
                <p className="text-2xl font-bold mb-4 text-[#F4F4F4]">
                  {faq.question}
                </p>
                <p className="text-xl leading-relaxed font-normal text-[#F4F4F4]">
                  {faq.answer}
                </p>
              </div>
            ))}
        ...
        <hr className=" w-300 mt-10 flex-grow border-[#F4F4F4] p-3 ml-50" />
        <p className="mt-10 text-sm text-center text-[#F4F4F4]">
